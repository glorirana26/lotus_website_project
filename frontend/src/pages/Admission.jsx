        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            >
              ...
              paid. The names of the selected candidates are also displayed in
              the notice board. In case of any complaint, the decision of the
              Principal of the destination school is final and binding.
            </p>
          </div>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            >
              The admission into the Higher Secondary School shall be done
              through the ONLINE e-admission procedure under SAMS for the
              academic session. Students shall download the Common Application
              Form from the Govt. of Odisha website (www.dheorissa.in) only
              after the publication of results from the Board of Secondary
              Education, Odisha.
            </p>
          </div>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            >
              Submission of Common Application Form (CAF)
            </h3>
            <div
              style={{
                width: 40,
            ...
            >
              After the Application Forms is collected from the Govt. website
              for admission into the +2 streams, the student must read the CAF
              carefully and fill it in CAPITAL LETTERS and submit the form
              online only. Printed copy of the form and certificates will be
              submitted in the destination college / Resource Centre / Nodal
              College within the prescribed period by the Govt. of Odisha.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                TOTAL 2 YEARS (CHSE) :{" "}
                <span style={{ color: "#f5a623" }}>₹ 1,28,600/-</span>
              </p>
              <p
                style={{
                  fontSize: 15,
              ...
              >
                TOTAL 2 YEARS (CBSE) :{" "}
                <span style={{ color: "#f5a623" }}>₹ 1,81,200/-</span>
              </p>
            </div>
            ...
            >
              ...
              >
                ⚠️ For Integrated NEET or IIT-JEE:{" "}
                <strong>₹ 30,000/- Extra per Year</strong>
              </p>
            </div>
